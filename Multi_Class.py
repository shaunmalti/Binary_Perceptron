...
def multi_train(array, weights_1_array, b_1_array, class_val):
    # initialisation of training (un)accuracy array
    train_corr = np.array([0],)
    # do training for 100 times
    for i in range(0, 100):
        # train
        weights1, b1, train_inst_cor = (train(array, class_val, i))
...
def main():
    ...
    final_weights_1, final_b_1 = multi_train(array1, weights_1_array, b_1_array, class_val="class-1")

    # train perceptron returning the weights and bias variable
    final_weights_2, final_b_2 = multi_train(array2, weights_2_array, b_2_array, class_val="class-2")

    # train perceptron returning the weights and bias variable
    final_weights_3, final_b_3 = multi_train(array3, weights_3_array, b_3_array, class_val="class-3")
    ...
    print("Bias for perceptron 1: ", final_b_1)
    print("Final Weights for perceptron 2: ", final_weights_2)
    print("Bias for perceptron 2: ", final_b_2)
    print("Final Weights for perceptron 3: ",final_weights_3)
    print("Bias for perceptron 3: ", final_b_3)
